...
* [🔧 `ReviewPipelineStyles`](https://package.elm-lang.org/packages/SiriusStarr/elm-review-pipeline-styles/1.2.0/ReviewPipelineStyles/) - Reports pipelines that are not valid by user-defined rules.
...
[`ReviewPipelineStyles.Premade`](https://package.elm-lang.org/packages/SiriusStarr/elm-review-pipeline-styles/1.2.0/ReviewPipelineStyles-Premade/)
...
* `1.2.0`
  * ✨ Added new [`noMultilineLeftComposition`](https://package.elm-lang.org/packages/SiriusStarr/elm-review-pipeline-styles/1.2.0/ReviewPipelineStyles-Premade#noMultilineLeftComposition)
  and [`noSingleLineRightComposition`](https://package.elm-lang.org/packages/SiriusStarr/elm-review-pipeline-styles/1.2.0/ReviewPipelineStyles-Premade#noSingleLineRightComposition)
  premade rules.
...
* `1.1.0`
  ...
  * Added [`StepPredicate`](https://package.elm-lang.org/packages/SiriusStarr/elm-review-pipeline-styles/1.2.0/ReviewPipelineStyles-Predicates/#step-predicates)s.  Easily inspect
